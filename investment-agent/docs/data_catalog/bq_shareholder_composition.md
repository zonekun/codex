...
| REAL_TOP_NAME | STRING | NULLABLE | 信託口スキップ後の実質筆頭株主名 (2026-05-16追加) |
| REAL_TOP_RATIO | FLOAT64 | NULLABLE | 実質筆頭株主持株比率 |
| REAL_TOP_TYPE | STRING | NULLABLE | 実質筆頭株主のTYPE (INDIVIDUAL/INSTITUTION/PRIVATE_CORP等) |
| OWNER_COUNT_IN_TOP10 | INT64 | NULLABLE | TOP10中のINDIVIDUAL+ASSET_MGMT件数 |
| OWNER_RATIO_IN_TOP10 | FLOAT64 | NULLABLE | TOP10中のINDIVIDUAL+ASSET_MGMT合計持株比率 |
| HAS_FAMOUS_INVESTOR | BOOL | NULLABLE | TOP10に有名個人投資家(≥20銘柄出現)が含まれるか |
| HAS_BUSINESS_PARTNER_INVESTOR | BOOL | NULLABLE | TOP10 に LISTED_CORP TYPE の株主が1件以上含まれるか（Plan C 追加） |
